 ...
 */
export async function parseQuintoAndar(
  url: string, 
  config: ParserConfig
): Promise<ParsingResult> {
  try {
    console.log('Parsing QuintoAndar:', url);
    ...
    // Extrair dados usando regex (simplificado para MVP)
    ...
    // Preço (procura por padrões de preço)
    ...
    console.error('Erro parsing QuintoAndar:', error);
    return {
      success: false,
